...
@NullMarked
class ImroNp3020 extends ImroIO {
    protected ImroNp3020() {
        super(NpxProbeType.np3020);
    }

    /// [reference](https://github.com/billkarsh/SpikeGLX/blob/bc2c10e99e68dcc9ec6b9a9c75272a74c7e53034/Src-imro/IMROTbl_T3020base.cpp#L50)
    @Override
    public boolean parseElectrodes(int[] args) {
        ...
        reference = args[3];
        var ec = args[4];
        assert new ChannelMapUtil.CB(channel, bank).equals(ChannelMapUtil.e2c3020(shank, ec));

        var cr = ChannelMapUtil.e2cr(type, ec);
        return addElectrode(new Electrode(shank, cr.c(), cr.r()));
    }

    /// [reference](https://github.com/billkarsh/SpikeGLX/blob/bc2c10e99e68dcc9ec6b9a9c75272a74c7e53034/Src-imro/IMROTbl_T3020base.cpp#L37)
    @Override
    public void stringElectrode(PrintStream out, int channel, Electrode e) {
        var electrode = ChannelMapUtil.cr2e(type, e);
        var cb = ChannelMapUtil.e2c3020(e.shank, electrode);
