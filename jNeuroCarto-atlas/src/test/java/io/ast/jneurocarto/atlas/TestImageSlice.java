...
public class TestImageSlice {
    ...
    public void projectOnCoronal() {
        var slices = new ImageSlices(25, VOLUME, ImageSlices.View.coronal);
    ...
    public void projectOnSagittal() {
        var slices = new ImageSlices(25, VOLUME, ImageSlices.View.sagittal);
        var actual = slices.project(new BrainAtlas.CoordinateIndex(10, 20, 30));
    ...
    public void projectOnTransverse() {
        var slices = new ImageSlices(25, VOLUME, ImageSlices.View.transverse);
        var actual = slices.project(new BrainAtlas.CoordinateIndex(10, 20, 30));
