...
public class XYMatrix extends XYSeries {
    ...
    public void addData(FlatIntArray data) {
        addData(data, true);
    }
     ...
     */
    public void addData(FlatIntArray data, boolean flip) {
        if (data.ndim() != 2) throw new IllegalArgumentException("not a 2d data");

        var row = data.shape()[0];
        var col = data.shape()[1];
    ...
    public void addData(FlatDoubleArray data) {
        addData(data, true);
    }
     ...
     * @param flip flip y direction. If {@code true}, the first row has largest y pos.
     */
    public void addData(FlatDoubleArray data, boolean flip) {
        if (data.ndim() != 2) throw new IllegalArgumentException("not a 2d data");
